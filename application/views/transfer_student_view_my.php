...
<ul class="nav nav-tabs" role="tablist" id="all_tabs">
    ...
    <li role="presentation" class=""><a id="#bulk_subject_approve_tab" href="#bulk_subject_approve_tab" aria-controls="enter_marks_tab"
                               role="tab" data-toggle="tab">Bulk Approve Student</a></li>                                                      
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="col-md-7">                                
                                ...
                                <!--<input type="button" id="upload" value="Upload" onclick="uploadExcel()" />-->
                                <!--  </div>-->
                            </div>
...
<!--                <form action="<?php// echo base_url('student/do_upload'); ?>" method="post" enctype="">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="col-md-7">
                                  <div class="col-md-offset-4 col-md-11">
                                <button type='submit' class='btn btn-primary'> onclick='event.preventDefault();upload_marks();'Upload
                                </button>
                                  </div>
                            </div>
...
//                                                }  
                                                    ...
                                                    if (typeof (FileReader) != "undefined") {
                                                        ...
                                                        if (reader.readAsBinaryString) {
                                                            reader.onload = function (e) {
                                                                process_bulk_result(e.target.result);
                                                            };
                                            ...
                                            function processExcel(data) 
                                            {
                                                ...
                                                //alert(JSON.stringify(excelRows));
                                                var batch_id = $('#upload_batch').val();
                                                var course_id = $('#upload_course').val();
                                                ...
                                                function (se_data) 
                                                {
                                                    jQuery.each( excelRows, function( index, value ) {
                                                        ...
                                                        //alert(flag);
                                                        alert('first');
                                                        /*$.post("<?php echo base_url('subject/get_student_details_for_excel_file_upload') ?>", {
                                                        ...
                                                        async: false,
                                                        type: "POST",
                                                        url: "subject/get_student_details_for_excel_file_upload'",
                                                        data: {'student_registration_number': value['StudentRegNo'], 
                                                            'subject_code': value['SubjectName']},
                                                        ...
                                                        success: function (data) {
                                                            ...
                                                            //{
                                                                ...
                                                                generateResultAndGrade(ca_mark,se_mark,flag,assignment_only,data_array,remarks,se_data);
                                                            //}
                                                            //else
                                                            //{
                                                                //funcres = {status: "Failed", message: "No students found for process the request !"};
                                                                //result_notification(funcres);
                                                            ///}
                                                        }      
                                                    });
                                            ...
                                            function generateResultAndGrade(ca_mark,se_mark,flag,assignment_only,row,remarks,se_data) {
                                                ...
                                                $.post("<?php echo base_url('Student/get_relevent_marking_details') ?>", {'course_id': row['course_id'], 'year_no': row['year_no'], 'sem_no': row['semester_no'], 'batch_no': row['batch_id'], 'subject_id': row['subject_id']},
                                                function (data) {
                                                    alert(data.length);
                                                    for (var i = 0; i < data.length; i++) {
                                                        ...
                                                        $.post("<?php echo base_url('Grading_method/get_grades') ?>", {'grading_id': grading_id},
                                                        function (data) {
                                                            gradeing_details = data;

                                                            //$.post("<?php echo base_url('subject/get_is_attend_and_absent_reson_approve') ?>", {'student_id': row['student_id'], 'subject_id': row['subject_id']},
                                                            //function (data) {
                                                                is_attend = 1;//data['is_attend'];
                                                                absent_reson_approve = 1;//data['is_absent_approve'];
                                                                //alert(flag);
                                                                if (flag) { 
                                                                    //----CALCULATE CA RESULT----- 
                                                                    mark_type = "ca_mark";
                                                                    ...
                                                                    {*/
                                                                        //************************************************SE
                                                                        for (var j = 0; j < se_data.length; j++) {
                                                                            for (var x = 0; x < se_data[j]['exam_mark'].length; x++) {                                           
                                                                                if(se_data[j]['exam_mark'][x]['exam_type_id'] == 2){
                                                                                    ca_type_in_db = parseInt(se_data[j]['exam_mark'][x]['exam_type_id']);
                                                                                    ca_percentage_in_db = parseInt(se_data[j]['exam_mark'][x]['persentage']);
                                                                                    ca_mark_for_total = parseInt(se_data[j]['exam_mark'][x]['mark']);
                                                                                }
                                                                            }
                                                                        }
                                            ...
                                            alert(result_grade);
                                                $.post("<?php echo base_url('exam/save_exam_marks') ?>", {
                                            ...
                                            function process_bulk_result(data)
                                            {
                                                alert('ss');
                                                //Read the Excel File data.
                                                var workbook = XLSX.read(data, {
                                                ...
                                                //send excel data and form data in to Backend to process the result.
                                                $.post("<?php echo base_url('exam/process_bulk_result') ?>", {
                                                    'batch_id': batch_id,
                                                    'year': year_no,
                                                    'semester': semester_no,
                                                    'course_id': course_id,
