...
$column_name2='';
    ...
    foreach ($sem_subject_detail_array as $va) {
       // print_r($stu_course_wise_count_array);
         $item  .= '<tr nobr="true">'.
                    '<td align="center" style="width:60px">'.$va['course_code'].'</td>'.
                    '<td align="center" style="width:60px">'.$va['batch_code'].'</td>'.
                    '<td align="center" style="width:60px">'.$va['year_no'].'</td>'.
                    '<td align="center" style="width:60px">'.$va['semester_no'].'</td>'.
                    '<td align="center" style="width:70px">'.$va['group_name'].'</td>'.
                    '<td align="center" style="width:100px">'.$va['subject'].'</td>'.
                    '<td align="center" style="width:100px">'.$va['code'].'</td>'.
                '</tr>';
           ...
           '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br><br>'.
              ...
              //  '<label align="center"> Email: '.$this->db->get_where('hgc_branch', array('br_id' => $pay['br_id']))->row()->br_telephone.'</label><br>'.
               ...
               // '<label align="center" style="font-size:14px;"><strong>CHEQUE RETURN</strong></label><br>'.
                '<br>'.
                '<label align="center" style="font-size:12px;">'.$course.' Course '.$subject.' Subject Groups Details</label><br><br><br>'.
 
    '<table border="0.5" style="width:100%; vertical-align:center;" cellspacing="0" cellpadding="5">'.
    '<thead>'.
        '<tr>'.
            '<th align="center"style="width:60px"><b>Course</b></th>'.
            '<th align="center" style="width:60px"><b>Batch Code</b></th>'.
            '<th align="center" style="width:60px"><b>Year</b></th>'.
            '<th align="center" style="width:60px"><b>Semester</b></th>'.
            '<th align="center" style="width:70px"><b>Subject Group</b></th>'.
            '<th align="center" style="width:100px"><b>Subject Name</b></th>'.
            '<th align="center" style="width:100px"><b>Subject Code</b></th>'.
        '</tr>'.
    '</thead>'.
    '<tbody id="tbl_body">'.
    $item.
