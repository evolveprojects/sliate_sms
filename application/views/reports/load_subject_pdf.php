...
$banch;
    foreach ($lecturer_subjects as $va) {
       // print_r($stu_course_wise_count_array);
         $item  .= '<tr nobr="true">'.
//                    '<td style="width:170px">'.$va['br_name'].'</td>'.
                    '<td style="width:250px">'.$va['code'].'</td>'.
                    '<td align="left" style="width:250px">'.$va['subject'].'</td>'.
                   '</tr>';
   ...
   $content =
    ...
    '<thead>'.
        '<tr>'.
//            '<th align="center"style="width:170px"><b>Center</b></th>'.
            '<th align="center" style="width:250px"><b>Subject Code</b></th>'.
            '<th align="center" style="width:250px"><b>Subject Name</b></th>'.
            '</tr>'.
    '</thead>'.
    '<tbody id="tbl_body">'.
    $item.
