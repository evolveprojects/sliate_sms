...
$column_name2='';
    ...
    foreach ($student_sttendees_detail_array as $va) {
       // print_r($stu_course_wise_count_array);
         $item  .= '<tr nobr="true">'.
                    
                    '<td align="center" style="width:100px">'.$va['reg_no'].'</td>'.
                    '<td align="center" style="width:100px">'.$va['first_name']." ".$va['last_name'].'</td>'.
...
//    $semester   = $va['ttbl_semester'];
    ...
    elseif ($year == 2){
        $Ordinal = "<sup>nd year</sup><label> year</label>";
    }
    elseif ($year == 3){
        $Ordinal = "<sup>rd year</sup><label> year</label>";
    }
    elseif ($year == 4){
        $Ordinal = "<sup>th year</sup><label> year</label>";
    }
    else{}
    ...
    elseif ($semester == 2){
        $Ordinaly = "<sup>nd semester</sup><label> semester</label>";
    }
    elseif ($semester == 3){
        $Ordinaly = "<sup>rd semester</sup><label> semester</label>";
    }
    elseif ($semester == 4){
        $Ordinaly = "<sup>th semester</sup><label> semester</label>";
    }
    else{}
           ...
           '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br><br>'.
              ...
              //  '<label align="center"> Email: '.$this->db->get_where('hgc_branch', array('br_id' => $pay['br_id']))->row()->br_telephone.'</label><br>'.
               ...
               // '<label align="center" style="font-size:14px;"><strong>CHEQUE RETURN</strong></label><br>'.
                '<br>'.
                '<label align="center" style="font-size:12px;">'.$course.' ['.$bach.'] '.$year.''.$Ordinal.' '.$semester.''.$Ordinaly.' Exam Attendees Details Report</label><br><br><br>'.
 
    '<table border="0.5" style="width:100%; vertical-align:center;" cellspacing="0" cellpadding="5">'.
    '<thead>'.
        '<tr>'.
            '<th align="center" style="width:100px"><b>Registration Number</b></th>'.
            '<th align="center" style="width:100px"><b>Student Name</b></th>'.
            '<th align="center" style="width:100px"><b>Signature</b></th>'.
