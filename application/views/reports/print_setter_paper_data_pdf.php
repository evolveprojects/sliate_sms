...
foreach ($student_applied_exam_array as $va) {
    ...
    $item .= '<tr nobr="true">' .
            '<td align="center" style="width:100px">' . $va['ese_description'] . '</td>' .
            '<td align="center" style="width:100px">' . $va['code'] . '</td>' .
            '<td align="center" style="width:150px">' . $va['set_tit'].' '. $va['set_name'] .' ' . $va['set_lname'] . '</td>' .
            '<td align="center" style="width:150px">'  . $va['mod_tit'] .' ' . $va['mod_name'] . ' ' . $va['setm_lname'].'</td>' .
...
$content = '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br><br>' .
        ...
        '<label align="center" style="font-size:12px;"> '.$year.''.$Ordinal.' '.$semester.''.$Ordinaly.'  Exam</label><br><br><br>' .
        '<label align="center" style="font-size:12px;"> '.$subject_code.' Subject</label><br><br>' .
        '<table border="0.5" style="width:100%; vertical-align:center;" cellspacing="0" cellpadding="5">' .
        '<thead>' .
        '<tr>' .
        '<th align="center" style="width:100px"><b>Exam</b></th>' .
        '<th align="center" style="width:100px"><b>Subject</b></th>' .
        '<th align="center" style="width:150px"><b>Paper Setter</b></th>' .
        '<th align="center" style="width:150px"><b>Paper Moderator</b></th>' .
        '</tr>' .
        '</thead>' .
        '<tbody id="tbl_body">' .
        $item .
