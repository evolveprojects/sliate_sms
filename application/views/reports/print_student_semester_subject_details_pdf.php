...
$title = "Students Semester Subjects Details Summary";
...
foreach ($student_sem_subject_detail_array as $va) {
    // print_r($stu_course_wise_count_array);
    $code = '';
    for ($e = 0; $e < sizeof($va['subjects']); $e++) {

        $code .= $va['subjects'][$e]['code'] ." - ".$va['subjects'][$e]['subject']." <br>";
    }
    $item .= '<tr nobr="true">' .
            '<td align="center" style="width:90px">' . $va['reg_no'] . '</td>' .
            '<td align="center" style="width:70px">' . $va['first_name'] . '</td>' .
            '<td align="center" style="width:60px">' . $va['year_no'] . '</td>' .
            '<td align="center" style="width:60px">' . $va['semester_no'] . '</td>' .
            '<td align="left" style="width:160px">' . $code . '</td>' .
            '</tr>';
...
$content = '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br><br>' .
        ...
        '<br>' .
//        .$year.''.$Ordinal.' Year And '.$semester.''.$Ordinaly.' Semester '
        '<label align="center" style="font-size:12px;">'.$subject.' '. $center . ' ' . $course .' '.$batch.' Students Semester Subjects Report</label><br><br><br>' .
        '<table border="0.5" style="width:100%; vertical-align:center;" cellspacing="0" cellpadding="5">' .
        '<thead>' .
        '<tr>' .
        '<th align="center" style="width:90px"><b>Registration No</b></th>' .
        '<th align="center" style="width:70px"><b>Student Name</b></th>' .
        '<th align="center" style="width:60px"><b>Year</b></th>' .
        '<th align="center" style="width:60px"><b>Semester</b></th>' .
        '<th align="center" style="width:160px"><b>Subject Code</b></th>' .
        '</tr>' .
        '</thead>' .
        '<tbody id="tbl_body">' .
        $item .
