...
if(!empty($student_applied_exam_array)){
...
$year_no;
    if($year_no == 1){
        $ordinal = '<sup>st</sup> Year';
    }else if($year_no == 2){
        $ordinal = '<sup>nd</sup> Year';
    }else if($year_no == 3){
        $ordinal = '<sup>nd</sup> Year';
    }else{}
    ...
    $sem = '' ;
    if($semester_no == 1){
        $sem = '<sup>st</sup> Semester';
    }else if($semester_no == 2){
        $sem = '<sup>nd</sup> Semester';
...
$content = '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br>' .
        '<br>'.
        '<label align="center" style="font-size:8px;"><b>Exam Applied Student Signature List</b></label><br>'.
        '<label align="center" style="font-size:8px;">'.$va['code'].' - '.$va['subject'].'</label><br>'.
        '<label align="center" style="font-size:8px;">'.$year_no.''.$ordinal.' '.$semester_no.''.$sem.'</label><br><br>'.
        ...
        '<th align="center"><b>Signature</b></th>'.
//        '<th align="center"><b>Signature</b></th>'.
