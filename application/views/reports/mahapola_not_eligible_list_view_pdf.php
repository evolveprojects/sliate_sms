...
$this->load->library('tcpdf/tcpdf');
		...
		$title = "Mahapola Not Eligible Students Summary";
...
$search_course = '';
   ...
   $content =
           ...
           '<label align="center" style="font-size:13px;"><strong>Sri Lanka Institute of Advanced Technoligical Education (SLIATE)</strong></label><br><br>'.
                '<br>'.
                '<label align="center" style="font-size:12px;">Mahapola Not Eligible Students List Report</label><br><br><br>'.
                ...
                '<label align="left" style="font-size:8px; line-height: 6%;">No of not Eligible Students for Mahapola                                 : '.$mahapola_report_data['mp_count'][0]['mp_count'].'</label><br><br><br>'.
