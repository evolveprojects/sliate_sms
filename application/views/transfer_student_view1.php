...
<ul class="nav nav-tabs" role="tablist" id="all_tabs">
    <li role="presentation" class="active"><a id="#transfer_tab" href="#transfer_tab" aria-controls="transfer_tab"
    ...
    <li role="presentation"><a id="#enter_marks_tab" href="#enter_marks_tab" aria-controls="enter_marks_tab"
...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="transfer_tab">
        <div class="panel">
    ...
    <div role="tabpanel" class="tab-pane" id="enter_marks_tab">
        <div class="panel">
            <div class="panel-heading">
