...
<div class="content-header">
    <div class="container">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Set Student Registration Year</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Set Student Registration Year</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0">Student Registration Year</h5>
                    </div>
                    <div class="card-body">
                        <form role="form" id="set_year_form" name="set_year_form" method="post" action="<?php echo base_url('App/set_student_registration_year') ?>">
                            <div class="card-body">
