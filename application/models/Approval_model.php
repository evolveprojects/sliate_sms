...
class Approval_model extends CI_Model
{
    ...
    function get_all_approval_students($year)
    {
    ...
    function get_all_approval_mahapola_students()
    {
    ...
    function get_all_rejected_students($year)
    {
    ...
    function get_all_rejected_mahapola_students()
    {
    ...
    function get_mahapola_applied_years(){        
    ...
    function get_all_approval_staff()
    {
    ...
    function get_all_rejected_staff()
    {
    ...
    function get_center_approval_staff()
    {
    ...
    function get_center_rejected_staff()
    {
    ...
    function get_center_approval_students($year)
    {
...
//    }
    ...
    function get_center_approval_mahapola_students()
    {
    ...
    function get_center_rejected_students()
    {
    ...
    function get_center_rejected_mahapola_students()
    {
    ...
    function update_student_approval_status($data)
    {
...
//            }
    ...
    function get_student_email($stu_id)
    {
    ...
    function get_staff_email($staff)
    {
        $this->db->select('*');
    ...
    function update_email_status($reg_no)
    {
    ...
    function change_student_mahapola_approval_status($data)
    {
    ...
    function update_staff_approval_status($data)
    {
    ...
    function search_mahapola_approve_students_lookup($data)
    {
    ...
    function search_staff_tobe_approve($data)
    {
...
//        }
    ...
    function get_all_rejected_update_students()
    {
    ...
    function get_all_approval_update_students()
    {
        $this->db->select('*');
    ...
    function update_stu_apprv_sem_upgrade_status($data)
    {
    ...
    function search_mahapola_director_approval_list($data)
    {
    ...
    function bulk_approve_mahapola_students($data)
    {
    ...
    function bulk_approve_exam_students($data)
    {
...
//        $this->db->join('edu_course ec, ec.id     = st.course_id');
    ...
    function get_postpone_by_center()
    {
...
//                $this->session->set_flashdata('flashSuccess', 'Postpone Request Rejected successfully.');
    ...
    function update_graduation_approval_status($data){
    ...
    function get_exam_timetable_reject()
    {
        $faclist = $this->auth->get_accessfaculties($branch = array(), 'ID_ARY');
    ...
    function get_lecture_timetable_reject()
    {
        $this->db->select('*');
        $this->db->join('exm_exam ee', 'ee.id=te.ttbl_exam');
        //$this->db->join('edu_course ec','ec.id=te.ttbl_course');
    ...
    function search_exam_ttbl($data)
    {
    ...
    function update_examtime_status($data)
    {
        $this->db->trans_begin();
    ...
    function update_exam_status($data)
    {
        $this->db->trans_begin();
    ...
    function update_exam_rej_status($data)
    {
...
//        }
    ...
    function get_edu_semester_id($course_id, $year_no)
    {
    ...
    function get_max_rej_exam_mark_id()
    {
    ...
    function update_exam_approval_level2($data)
    {
        $this->db->trans_begin();
...
//                }     
    ...
    function academic_exam_request_bulk_approval($data){
        $this->db->trans_begin();
    ...
    function load_student_approval_subjects($data)
    {
    ...
    function load_student_request_approval_subjects($data){
    ...
    function approve_student_subject($data)
    {
        $this->db->trans_begin();
    ...
    function search_students_lookup1($data)
    {
        //$this->db->join('stu_follow_subject sfc', 'sfc.student_subject_id=sc.id');
        $this->db->select('*');
    ...
    function update_exam_approval_status1($data)
    {
    ...
    function mark_approve_status_hod($data)
    {
        $this->db->trans_begin();
        //call mark save
...
//        //}
    ...
    function mark_approve_status_dir($data)
    {
        $this->db->trans_begin();
        //call mark save
        /* if ($data['overall_grade'] != 'AB') {
...
//return $exam_mark_details_id;
    ...
    function mark_approve_status_ex_dir($data)
    {
        $this->db->trans_begin();
        //call mark save
        /* if ($data['overall_grade'] != 'AB') {
...
//=================================End insert GPA values ==============================================
    ...
    function get_subject_marking_method_details($data){
...
//        $this->db->order_by("co.code", "asc");
    ...
    function load_semester_subjects_deferement($data){
         $this->db->select('*,co.type as subject_type');
        $this->db->join('mod_semester_subject_details sd', 'sc.id = sd.semester_subject_id');
        $this->db->join('edu_semester se', 'se.id = sc.semester_id');
        $this->db->join('edu_year yr', 'yr.id = se.year_id');
...
//            $this->db->join('stu_follow_subject fc', 'sc.id = fc.student_subject_id');
    ...
    function deferement_approval($data){
        $this->db->trans_begin();
...
//        )
    ...
    function deferement_approval_repeat($data){
    ...
    function deferement_reject($data){
        $this->db->trans_begin();
...
//        )
    ...
    function deferement_reject_repeat($data){
        $this->db->trans_begin();
    ...
    function view_gpa_results($data){
        $this->db->select('*');
    ...
    function update_recorrection_status($data){    
    ...
    function get_mark_data_for_recorrection($data){
    ...
    function load_recorrect_course_student()
    {
        $this->db->select('cr.id as course_id, cr.course_code, cr.course_name');
        $this->db->join('edu_center_course ecc', 'cr.id=ecc.course_id');
        $this->db->where('ecc.center_id', $this->input->post('center_id'));
    ...
    function load_recorrect_batches($course_id)
    {
        $this->db->select('*');
        $this->db->where('deleted', 0);
    ...
    function load_recorrect_batches_student($course_id, $id)
    {
        $this->db->select('*');
    ...
    function load_recorrect_exam($data, $batch_details)
    {
    ...
    function load_batch_details_by_id($batch_id)
    {
        $this->db->select('*');
    ...
    function rpt_approve_student($data)
    {
        $this->db->trans_begin();
        $student_array = array();
...
//                $this->db->update('exm_mark', $update_exm_mark);
    ...
    function rpt_reject_student($data)
    {
        $this->db->trans_begin();
        $student_array = array();
        $sem_exam_detail_id = array();
...
//                $this->db->update('exm_mark', $update_exm_mark);
    ...
    function check_subject_mark_exists_rpt($data, $student)
    {
        $this->db->select('*');
    ...
    function get_exam_mark_details_rpt($mark_id, $subject_id){
    ...
    function bulk_dir_mark_approval($exm_mark_id, $user_level, $student_id,$form_data,$recorrectionFlag)
    {
        $result = true;
        if ($user_level == 'dir') {
...
//                    else{
    ...
    function get_applied_subject($exm_mrk_id, $is_repeat){
    ...
    function update_gpa_se_approval ($exm_mark_id,$student_id,$form_data,$repeat_flag,$recorrectionFlag) {
    ...
    function bulk_rpt_dir_mark_approval($exm_mark_id, $user_level,$student_id,$form_data,$recorrectionFlag)
    {
        $result = true;
        if ($user_level == 'dir') {
            $is_repeat = 1;
...
//                    else{
    ...
    function cancel_postpone_status($data)
    {
        $this->db->trans_begin();
    ...
    function get_postpone_graduation_student_data ($data){
     ...
     function update_exam_status_bulk($stu_data)
    {
        $this->db->trans_begin();
    ...
    function bulk_mark_approval_training($exm_mark_id,$student_id,$form_data)
    {
        $result = true;
    ...
    function rpt_bulk_mark_approval_training($exm_mark_id,$student_id,$form_data)
    {
        $result = true;
