...
//            $result_array['gpa_value']=0;
        ...
        $result_array['subject_details']['marking_details'] = $this->get_relevent_marking_details($data['course_id'], $data['year_no'], $data['semester_no'], $current_stu_batch, $subject_id);
